...
In this exercise I learned how to debug by using rspec, tightening the loop, and getting visibility with print commands. I also learned how to not always trust code - even libraries!, how to access Gem source code, practice reading other people's code, and debug using a larger code base than I was used to. I managed to fix all the bugs - but forgot to use git to regularly commit at each stage, so that's something to work on!
